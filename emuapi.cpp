...
int emu_ReadKeys(void) 
{
  ...
  if ( ~inputs & 0b10000000 ) j2 |= MASK_JOY2_RIGHT;
  if ( ~inputs & 0b00000100 ) j2 |= MASK_JOY2_LEFT;
  if ( ~inputs & 0b00000001 ) j2 |= MASK_JOY2_BTN;
  ...
  if ( ~inputs & 0b00001000 ) retval |= MASK_KEY_USER1;
  if ( ~inputs & 0b00000010 ) retval |= MASK_KEY_USER2;
  if ( ~inputs & 0b00010000 ) retval |= MASK_KEY_USER3;
